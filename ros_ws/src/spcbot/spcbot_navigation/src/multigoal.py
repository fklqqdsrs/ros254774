...
#Unpacking the quaternion list and passing it as arguments to Quaternion message
#constructor
            quat_seq.append(Quaternion(*(quaternion_from_euler(0, 0,
                                 yawangle*math.pi/180, axes='sxyz'))))
        n = 3
